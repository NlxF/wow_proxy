...
#ifndef SOAP_TYPE_ns__sum_DEFINED
#define SOAP_TYPE_ns__sum_DEFINED
...
SOAP_FMAC3 struct ns__sum * SOAP_FMAC4 soap_new_ns__sum(struct soap *soap, int n);
...
#define soap_write_ns__sum(soap, data) ( soap_free_temp(soap), soap_begin_send(soap) || (soap_serialize_ns__sum(soap, data), 0) || soap_put_ns__sum(soap, data, "ns:sum", "") || soap_end_send(soap), (soap)->error )
#endif


#ifndef soap_PUT_ns__sum
#define soap_PUT_ns__sum(soap, URL, data) ( soap_free_temp(soap), soap_PUT(soap, URL, NULL, "text/xml; charset=utf-8") || (soap_serialize_ns__sum(soap, data), 0) || soap_put_ns__sum(soap, data, "ns:sum", "") || soap_end_send(soap) || soap_recv_empty_response(soap), soap_closesock(soap) )
#endif


#ifndef soap_POST_send_ns__sum
#define soap_POST_send_ns__sum(soap, URL, data) ( soap_free_temp(soap), ( soap_POST(soap, URL, NULL, "text/xml; charset=utf-8") || (soap_serialize_ns__sum(soap, data), 0) || soap_put_ns__sum(soap, data, "ns:sum", "") || soap_end_send(soap) ) && soap_closesock(soap), (soap)->error )
#endif
...
#define soap_read_ns__sum(soap, data) ( ((data) ? (soap_default_ns__sum(soap, (data)), 0) : 0) || soap_begin_recv(soap) || !soap_get_ns__sum(soap, (data), NULL, NULL) || soap_end_recv(soap), (soap)->error )
#endif


#ifndef soap_GET_ns__sum
#define soap_GET_ns__sum(soap, URL, data) ( soap_GET(soap, URL, NULL) || soap_read_ns__sum(soap, (data)), soap_closesock(soap) )
#endif


#ifndef soap_POST_recv_ns__sum
#define soap_POST_recv_ns__sum(soap, data) ( soap_read_ns__sum(soap, (data)) || soap_closesock(soap), (soap)->error )
#endif

#endif

#ifndef SOAP_TYPE_ns__sumResponse_DEFINED
#define SOAP_TYPE_ns__sumResponse_DEFINED
...
SOAP_FMAC3 struct ns__sumResponse * SOAP_FMAC4 soap_new_ns__sumResponse(struct soap *soap, int n);
...
#define soap_write_ns__sumResponse(soap, data) ( soap_free_temp(soap), soap_begin_send(soap) || (soap_serialize_ns__sumResponse(soap, data), 0) || soap_put_ns__sumResponse(soap, data, "ns:sumResponse", "") || soap_end_send(soap), (soap)->error )
#endif


#ifndef soap_PUT_ns__sumResponse
#define soap_PUT_ns__sumResponse(soap, URL, data) ( soap_free_temp(soap), soap_PUT(soap, URL, NULL, "text/xml; charset=utf-8") || (soap_serialize_ns__sumResponse(soap, data), 0) || soap_put_ns__sumResponse(soap, data, "ns:sumResponse", "") || soap_end_send(soap) || soap_recv_empty_response(soap), soap_closesock(soap) )
#endif


#ifndef soap_POST_send_ns__sumResponse
#define soap_POST_send_ns__sumResponse(soap, URL, data) ( soap_free_temp(soap), ( soap_POST(soap, URL, NULL, "text/xml; charset=utf-8") || (soap_serialize_ns__sumResponse(soap, data), 0) || soap_put_ns__sumResponse(soap, data, "ns:sumResponse", "") || soap_end_send(soap) ) && soap_closesock(soap), (soap)->error )
#endif
...
#define soap_read_ns__sumResponse(soap, data) ( ((data) ? (soap_default_ns__sumResponse(soap, (data)), 0) : 0) || soap_begin_recv(soap) || !soap_get_ns__sumResponse(soap, (data), NULL, NULL) || soap_end_recv(soap), (soap)->error )
#endif


#ifndef soap_GET_ns__sumResponse
#define soap_GET_ns__sumResponse(soap, URL, data) ( soap_GET(soap, URL, NULL) || soap_read_ns__sumResponse(soap, (data)), soap_closesock(soap) )
#endif


#ifndef soap_POST_recv_ns__sumResponse
#define soap_POST_recv_ns__sumResponse(soap, data) ( soap_read_ns__sumResponse(soap, (data)) || soap_closesock(soap), (soap)->error )
#endif
